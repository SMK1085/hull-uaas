...
You can [open a ticket](https://github.com/hull/hull-sql-exporter/issues/new) with your questions or issues any time. Feature requests are also welcome, please describe the feature, why you need it, and how it should work.
...
- You are using the [latest version](https://github.com/hull/hull-sql-exporter/releases).
- You have read the [technical documentation](https://github.com/hull/hull-sql-exporter/blob/master/README.md) and the [user documentation](https://github.com/hull/hull-sql-exporter/blob/master/assets/readme.md) first, and
